...
if (t == 1):
    # otu_nums = [100]
    otu_nums = [200,300,400,500,600,700,800,900,1000]
elif(t == 2):
    otu_nums = [1000,2000,3000]
elif(t == 3):
    otu_nums = [4000,5000,6000,7000,8000,9000,10000]
elif(t == 4):
    otu_nums = [6000,7000]
elif(t == 5):
    otu_nums = [8000]
...
tree_info_csv = "./test_trees_info/random_trees.csv"
...
for otu_num in otu_nums:
    ...
    for i in range(run_start,run_end):
        ...
        if(t==8):
            ...
            f = open("./test_trees/tree" + str(otu_num) + "_" + str(i) + ".txt", "w")
            f.write(nwk)
            f.close()
        else:
