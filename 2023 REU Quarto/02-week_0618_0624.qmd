...
1. Only speciation
  - When all the species are different, we label the genes as "orthologous" 
2. Only duplication
  - When all the species are the same, we label them as "paralogous"
3. Mix of both
  - When the information about the order of speciation and duplication is unclear, the current solution is to label those genes as "ambiguous". 
  - Even in this case, a specific gene can be paralogous to one gene and have an ambiguous relaionship with another one
